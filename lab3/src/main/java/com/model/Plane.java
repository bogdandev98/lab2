...
public class Plane implements Comparable<Plane>{
     ...
     */
    public Plane() {
        this.pointStart = new SimpleStringProperty();
        this.pointFinish = new SimpleStringProperty();
        this.race = new SimpleIntegerProperty();
    ...
    public String toString() {
        return "'"+pointStart.get()+"', '"+pointFinish.get()+"', '"+race.get()+"', '"+type.get()+"', '"+dateToString()+"'";
    }
    /**
